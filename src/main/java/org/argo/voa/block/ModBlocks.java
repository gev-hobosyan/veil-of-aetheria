...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =  DeferredRegister.createBlocks(VeilofAetheria.MOD_ID);

    public static final DeferredBlock<Block> EDERIUM_BLOCK = registerBlock("ederium_block",
